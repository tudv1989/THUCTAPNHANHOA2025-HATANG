...
#### 1. Để kết nối KVM đến WebVirtCloud, cần thêm 1 số bước sau:
...
#### 2. Cho phép port 16509 của libvirt và dải 5900-5999 của VNC đi qua ufw
...
#### 3. Khởi động libvirtd-tcp.socket và enable libvirtd-tcp.socket , đảm bảo nó được khởi động trước libvirtd.service
...
Đảm bảo ``/etc/libvirt/libvirtd.conf`` được cấu hình đúng để lắng nghe TCP 16509
