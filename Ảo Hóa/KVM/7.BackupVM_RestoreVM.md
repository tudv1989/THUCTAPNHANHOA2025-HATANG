## Tạo một script tự động sao lưu máy ảo của node KVM.
...
Ví dụ restore máy ảo testCloneVM3-ubuntu22.04

  <img src="kvmimages/Screenshot_69.png">

### 3.1. Restore máy ảo trên cùng node

Mình sẽ destroy máy ảo testCloneVM3-ubuntu22.04 sau khi đã có 2 file backup: ``testCloneVM3-ubuntu22.04_full_20250327103629.qcow2`` và ``ubuntu22.04_config_full_20250327103629.xml``

  <img src="kvmimages/Screenshot_70.png">
...
####  3.2.2. Tạo thư mục lưu trữ máy ảo:
...
#### 3.2.3 Sao chép tệp sao lưu vào thư mục lưu trữ:

Sao chép tệp testCloneVM3-ubuntu22.04_full_20250327103629.qcow2 vào thư mục /var/lib/libvirt/images/restored_vms/.
Đổi tên tệp thành tên máy ảo bạn muốn khôi phục. Ví dụ:

    cp testCloneVM3-ubuntu22.04_full_20250327103629.qcow2 /var/lib/libvirt/images/restored_vms/restored_vm.qcow2

#### 3.2.4. Tạo tệp cấu hình máy ảo (XML):

Sao chép tệp ubuntu22.04_config_full_20250327103629.xml vào thư mục /etc/libvirt/qemu/.
Đổi tên tệp thành tên máy ảo bạn muốn khôi phục. Ví dụ:

    cp ubuntu22.04_config_full_20250327103629.xml /etc/libvirt/qemu/restored_vm.xml

#### 3.2.5. Chỉnh sửa tệp cấu hình máy ảo (XML):
