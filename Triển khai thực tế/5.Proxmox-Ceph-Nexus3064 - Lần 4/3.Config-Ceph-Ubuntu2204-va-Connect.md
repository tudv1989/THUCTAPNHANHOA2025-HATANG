...
#### Trên Cephnode134 chúng ta thao tác tạo pool tên ceph-pool-from134-for-131 để cho cụm proxmox kết nối vào Pool này:
...
Sau đó qua giao diện Cluster Proxmox HA để tạo kết nối
