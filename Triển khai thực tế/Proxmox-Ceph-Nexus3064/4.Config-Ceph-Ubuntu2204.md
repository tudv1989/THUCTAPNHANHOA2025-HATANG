...
## Connect đến Ceph Type RBD hoặc Storage Ceph client type Directory
...
Nếu bạn ko cần mount thì bỏ qua đoạn mount này, ko thì hãy đến đoạn tạo connect qua giao diện ``Qua đây chúng ta qua giao diện để add storage`` >> Mình làm test và ko mount
