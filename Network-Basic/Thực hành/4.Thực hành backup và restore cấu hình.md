...
## Khôi phục (Restore) cấu hình switch:
  ...
  Ví dụ:
  Cấu hình hiện hiện tại đã backup trước đó swcore1-confg20-02-2025.txt :

  <img src="Basicnetworkimages/53.png">

  Mình đã thay đổi port Gi1/0/2-8 allow vlan 200

  <img src="Basicnetworkimages/54.png">
